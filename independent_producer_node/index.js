...
const queue = rqJobGenerator(redisClient, process.env.IN_QUEUE, function () {
...
queue.enqueue('consumer1.consume.consume_func',  '{"a": "e.js"}', {}, function(){console.log('Job enqueued')})
